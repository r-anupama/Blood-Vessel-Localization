...
def traindatagen(batch_size=16):
    i=0
    j=0
    os.chdir("/Users/rahulr/Documents/GitHub/Blood-Vessel-Localization/us_images") # Directory where training images are being stored
    my_list = os.listdir()
    ...
    while True:
        ...
        os.chdir("/Users/rahulr/Documents/GitHub/Blood-Vessel-Localization/us_images")
        ...
        X[i,:,:,0] = img
        os.chdir("/Users/rahulr/Documents/GitHub/Blood-Vessel-Localization/results/ground_truth")
...
def testdatagen(batch_size=16):
    ...
    j=0
    listname = []
    os.chdir("/Users/rahulr/Documents/GitHub/Blood-Vessel-Localization/validation_image") # Directory where images are being stored
    my_list = os.listdir()
    ...
    while True:
        if i == batch_size:
            ...
            listname=[]
            yield X,Y,name_list
        os.chdir("/Users/rahulr/Documents/GitHub/Blood-Vessel-Localization/validation_image")
        img = cv2.imread(my_list[j])

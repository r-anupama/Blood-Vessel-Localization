...
def traindatagen(batch_size=16):
    i=0
    j=0
    os.chdir("/Users/rahulr/Documents/ImageSegmentation/Blood-Vessel-Localization/us_images") # Directory where training images are being stored
    my_list = os.listdir()
    ...
    while True:
        ...
        os.chdir("/Users/rahulr/Documents/ImageSegmentation/Blood-Vessel-Localization/us_images")
